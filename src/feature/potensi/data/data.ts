export const potensiHeroData = {
  badge: "Kekayaan Alam & Keterampilan Warga",
  title: "Potensi Lokal Desa Sukorame",
  description:
    "Menjelajahi keunggulan agrikultur yang melimpah, keterampilan industri permebelan warga, serta warisan budaya kearifan lokal yang menjadi kekuatan utama pembangunan ekonomi Desa Sukorame, Blitar.",
  imageTitle: "FOKUS UTAMA",
  imageSubtitle: "Sentra Permebelan & Agrikultur",
...
export const pilarEkonomiData = {
  ...
  description:
    "Empat sektor utama yang menggerakkan perekonomian dan kesejahteraan masyarakat Desa Sukorame secara berkelanjutan.",
  items: [
    {
      id: "permebelan",
