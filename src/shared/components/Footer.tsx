...
const Footer = () => {
  return (
    <footer className="mx-auto grid w-[90%] grid-cols-2 items-center justify-between rounded-tl-xl rounded-tr-xl bg-green-50 px-16 py-20">
      <div className="flex h-full flex-col gap-12">
        <div className="flex flex-col gap-4">
          ...
          <p className="font-inter-400 w-[60%] text-base text-[#FCF9F2CC]">
            Pusat informasi dan pelayanan publik Pemerintah Desa Sukorame untuk
