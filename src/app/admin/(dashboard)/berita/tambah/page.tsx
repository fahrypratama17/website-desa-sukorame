...
export default function TambahBeritaPage() {
  ...
  const AUTOSAVE_KEY = 'autosave_berita_baru';
    ...
    startTransition(async () => {
      ...
      try {
        ...
        if (result?.error) {
          ...
          // Jika sukses namun tidak ter-redirect karena error aneh, pastikan kita hapus localStorage
        ...
        if (isRedirect) {
          // Clear local storage on successful redirect
          localStorage.removeItem(AUTOSAVE_KEY);
          throw err;
        }
        setError("Gagal menyimpan berita. Silakan periksa koneksi internet Anda atau coba beberapa saat lagi.");
      }
    });
  };
