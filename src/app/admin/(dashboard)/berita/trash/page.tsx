          ...
          <table className="w-full text-left border-collapse">
            <thead>
              <tr className="bg-red-50 border-b border-red-100 text-red-800 font-inter-600 text-sm">
                ...
                <th className="px-4 sm:px-6 py-3 sm:py-4">Waktu Dihapus</th>
            ...
            <tbody className="divide-y divide-gray-100">
              {beritaList.length === 0 ? (
                <tr>
                  <td colSpan={6} className="px-4 sm:px-6 py-12 text-center text-gray-500 font-inter-400">
                    Tong sampah kosong.
                  </td>
                </tr>
              ) : (
                beritaList.map((berita, index) => (
                  <tr key={berita.id} className="hover:bg-red-50/30 transition">
                    ...
                    <td className="px-4 sm:px-6 py-3 sm:py-4 text-sm text-red-500 font-inter-500">
